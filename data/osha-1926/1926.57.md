...
source_url: "https://www.ecfr.gov/current/title-29/section-1926.57"
...
(v) Hazard potential shall be determined from Table D-57.9, with the value indicating greater hazard being used. When the hazardous material may be either a vapor with a threshold limit value (TLV) in p.p.m. or a mist with a TLV in mg./m.3, the TLV indicating the greater hazard shall be used (for example, A takes precedence over B or C; B over C; C over D).
...
Table D-57.9—Determination of Hazard Potential Hazard potential Toxicity group Gas or vapor (p.p.m.) Mist (mg./m3) Flash point in degrees F. (C.) A 0-10 0-0.1 B 11-100 0.11-1.0 Under 100 (37.77) C 101-500 1.1-10 100 200 (37.77-93.33) D Over 500 Over 10 Over 200 (93.33)
...
(iv) Tanks or machines of more than 4 square feet (0.368 m 2) of vapor area, used for solvent cleaning or vapor degreasing, shall be equipped with suitable cleanout or sludge doors located near the bottom of each tank or still. These doors shall be so designed and gasketed that there will be no leakage of solvent when they are closed.
