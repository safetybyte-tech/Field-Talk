...
Implementation: `public/snd-analytics-v1.js` loaded asynchronously from the HTML entry pages. PostHog SDK configuration: https://posthog.com/docs/libraries/js/config
